...
const MESSAGES = {
  es: {
    ...
    "editor.useRepoContext": "Usar memoria de {repo} como contexto (AGENTS.md, CLAUDE.md…)",
    "editor.memoryBranch": "Rama de memoria:",
    "editor.memoryBranchDefault": "por defecto",
    "editor.repoCtxReading": "Leyendo memoria de {repo}…",
    "editor.repoCtxLoaded": "✓ Memoria de {repo} cargada (rama {branch})",
    "editor.repoCtxEmpty": "Sin archivos de memoria en {repo} — se genera sin contexto de repo.",
    "editor.repoCtxUnavailable": "No se pudo leer la memoria de {repo} (acceso o repo inválido) — se genera sin contexto.",
    ...
    "editor.githubRepo": "Repositorio GitHub (opcional)",
    "editor.githubRepoPlaceholder": "owner/name (ejemplo: myorg/my-repo)",
    ...
    "editor.errNoRepos": "No se encontraron repositorios en tu cuenta de GitHub.",
...
"guide.checklist.autoNote": "auto",
    ...
    "menu.promptSettings": "Ajustes de prompts",
    ...
    "promptSettings.glossaryExplainDesc": "Este prompt se usa cuando se genera una explicación extendida para un término en el glosario.",
    "promptSettings.enterPrompt": "Ingresa el prompt aquí...",
    "promptSettings.saveSuccess": "Ajustes guardados correctamente",
    "promptSettings.saveError": "Error al guardar los ajustes",
    "promptSettings.reset": "Restablecer valores predeterminados",
    "promptSettings.resetConfirm": "¿Estás seguro de que deseas restablecer todos los prompts a sus valores predeterminados?",
  ...
  en: {
    ...
    "editor.useRepoContext": "Use {repo}'s memory as context (AGENTS.md, CLAUDE.md…)",
    "editor.memoryBranch": "Memory branch:",
    "editor.memoryBranchDefault": "default",
    "editor.repoCtxReading": "Reading {repo}'s memory…",
    "editor.repoCtxLoaded": "✓ {repo}'s memory loaded (branch {branch})",
    "editor.repoCtxEmpty": "No memory files found in {repo} — generating without repo context.",
    "editor.repoCtxUnavailable": "Couldn't read {repo}'s memory (access or invalid repo) — generating without context.",
    ...
    "editor.tagsPlaceholder": "java, tests",
    "editor.githubRepo": "GitHub repo (optional)",
    "editor.githubRepoPlaceholder": "owner/name (e.g. myorg/my-repo)",
    "editor.frontmatter": "Frontmatter (JSON)",
    ...
    "editor.errNoRepos": "No repositories were found in your GitHub account.",
    ...
    "menu.promptSettings": "Prompt settings",
    ...
    "promptSettings.glossaryExplainDesc": "This prompt is used when generating an extended explanation for a term in the glossary.",
    "promptSettings.enterPrompt": "Enter the prompt here...",
    "promptSettings.saveSuccess": "Settings saved successfully",
    "promptSettings.saveError": "Error saving settings",
    "promptSettings.reset": "Reset to default values",
    "promptSettings.resetConfirm": "Are you sure you want to reset all prompts to their default values?",
