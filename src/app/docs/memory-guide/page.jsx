    ...
    <main style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 20px 64px" }}>
      ...
      <div style={{ marginBottom: 8 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
          <BackLink />
          <Link href="/memory" style={{ fontSize: "0.85rem", color: "var(--bark)", display: "inline-flex", alignItems: "center", gap: 4, whiteSpace: "nowrap" }}>
            <BookOpen size={14} /> {t("nav.memory")}
          </Link>
        </div>
        <h1 style={{ fontSize: "1.75rem", lineHeight: 1.3, margin: "6px 0 0" }}>{title}</h1>
      </div>
